...
def predict():
    ...
    payload_scoring = {"input_data": [{"field": [['satisfaction_level', 'last_evaluation', 'number_project','average_montly_hours', 'time_spend_company', 'Work_accident','left', 'promotion_last_5years', 'department', 'salary']],
                   "values":  features_name}]}
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/da786aa6-424e-4a07-bdd2-6b51e95d497e/predictions?version=2021-07-12', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
